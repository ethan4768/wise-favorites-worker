...
export async function getLLMResult(
  ...
  const systemPrompt = `
generate tags, slug, an improved title and an improved description based on given URL, title, and description.
...
improved_description: Respond in Chinese, retain proper nouns such as prompt, AI, LLM, as detailed as possible, without missing any information.
...
Example:
{
  ...
  "improved_title": "微软开源OmniParser：解析和识别屏幕上可交互图标的工具",
  "improved_description": "微软开源了一款可以解析和识别屏幕上可交互图标的工具：OmniParser，它能准确的识别出用户界面中的可交互图标，在解析方面优于GPT-4V\n特点：\n1、双重识别能力，能找出界面上所有可以点击的地方，具备语义理解能力，能理解按钮或图标的具体功能\n2、可以作为插件，与Phi-3.5-V、 Llama-3.2-V以及其他模型结合使用\n3、支持结构化输出，除了识别屏幕上的元素，还能将这些元素转换成结构化的数据\ngithub：https://github.com/microsoft/OmniParser\n项目：https://microsoft.github.io/OmniParser/"
}
`;
